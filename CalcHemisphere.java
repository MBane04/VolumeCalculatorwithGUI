...
public class CalcHemisphere extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalcHemisphere frame = new CalcHemisphere();
	 ...
	 * Create the frame.
	 */
	public CalcHemisphere() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CalcHemisphere.class.getResource("/OpenEndedMiniProject/guicalcicon.png")));
		...
		JLabel lblSurfaceAreaCalculator = new JLabel("Surface Area Calculator for Hemisphere");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double output = 3*(Math.PI)*(Math.pow(radius, 2));
		...
		txtpnpiradius.setText("3(PI)(radius^2)");
						...
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
									...
									.addGap(62)
									.addComponent(btnE, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
									.addGap(50))
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGap(10)
