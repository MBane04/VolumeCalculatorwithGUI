...
public class CalcSquare extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalcSquare frame = new CalcSquare();
	 ...
	 */
	public CalcSquare() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CalcSquare.class.getResource("/OpenEndedMiniProject/guicalcicon.png")));
		...
		JLabel lblSurfaceAreaCalculator = new JLabel("Surface Area Calculator for Square");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double side = Double.parseDouble(getValue);
			
				double output = Math.pow(side, 2);
		...
		JLabel lblEnterX = new JLabel("Enter Side: ");
		...
		JTextPane txtpnside = new JTextPane();
		txtpnside.setText("(Side^2)");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(189)
					.addComponent(txtpnside, GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE)
					.addGap(18))
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(7)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(txtpnside, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
