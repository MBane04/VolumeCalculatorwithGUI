...
public class CalcCylinder extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalcCylinder frame = new CalcCylinder();
	 ...
	 */
	public CalcCylinder() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CalcCylinder.class.getResource("/OpenEndedMiniProject/guicalcicon.png")));
		...
		JLabel lblSurfaceAreaCalculator = new JLabel("Surface Area Calculator for Cylinder");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double output = 2*(Math.PI)*(radius)*(radius+height);
				textArea_1.setText(""+output); 
				textPane.setText("2(PI)(radius)(radius+height)");
			}
		});
