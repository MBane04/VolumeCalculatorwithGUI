...
public class CalcRectPrism extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalcRectPrism frame = new CalcRectPrism();
	 ...
	 * Create the frame.
	 */
	public CalcRectPrism() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CalcRectPrism.class.getResource("/OpenEndedMiniProject/guicalcicon.png")));
		...
		JLabel lblSurfaceAreaCalculator = new JLabel("Surface Area Calculator for Rectangular Prism\r\n");
		...
		JLabel lblSurfaceAreaCalculator_1_1 = new JLabel("Enter Length: ");
		...
		JTextPane txtpnLwh = new JTextPane();
		txtpnLwh.setText("L*W*H");
		...
		JLabel lblSurfaceAreaCalculator_1_1_1 = new JLabel("Enter Width: ");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(189)
					.addComponent(txtpnLwh, GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE)
					.addGap(18))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(105)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(txtpnLwh, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
					.addGap(10)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(lblSurfaceAreaCalculator_1_2)
