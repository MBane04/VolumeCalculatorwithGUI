	...
	public CalcCone() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double slant = Double.parseDouble(getValue2);
				double tempnumb = (Math.PI)*radius;
				textArea_1.setText(tempnumb+"( "+radius+" + "+" "+slant+" ) = " + tempnumb*(radius+slant));
