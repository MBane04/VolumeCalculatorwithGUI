...
public class CalcCube extends JFrame {
	 ...
	 */
	public CalcCube() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CalcCube.class.getResource("/OpenEndedMiniProject/guicalcicon.png")));
		...
		JLabel lblSurfaceAreaCalculator = new JLabel("Surface Area Calculator for Cube");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double cube = Double.parseDouble(getValue);
				double cubetext = 6*(Math.pow(cube, 3));
				textArea_1.setText(cubetext+"");
				textPane.setText("6a^2");
			}
		});
		...
		JLabel lblEnterX = new JLabel("Enter Cube: ");
