	...
	public CalcTrapezium() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double sideA = Double.parseDouble(getValue2);
				double sideB = Double.parseDouble(getValue3);
				double output = (1/2.0)*(sideA+sideB)*height;
		...
		JTextPane txtpnsideaSidebheight = new JTextPane();
		txtpnsideaSidebheight.setText("(1/2)(SideA + SideB)(Height)");
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(189)
					.addComponent(txtpnsideaSidebheight, GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE)
					.addGap(18))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(105)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(txtpnsideaSidebheight, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
					.addGap(10)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(lblSurfaceAreaCalculator_1_2)
